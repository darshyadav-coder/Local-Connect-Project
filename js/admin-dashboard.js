...
function renderAdminDashboard() {
    ...
    const dummyUsers = [
        { email: "user@gmail.com", role: "user", fullname: "Test User", location: "Global" },
        { email: "provider@gmail.com", role: "provider", fullname: "Test Provider", location: "Global" },
    ];
...
function renderUsers(list, tableBodyId) {
    ...
    tbody.innerHTML = "";
    if (list.length === 0) {
        tbody.innerHTML = "<tr><td colspan='3' style='text-align:center;'>No accounts found.</td></tr>";
        return;
    }
    list.forEach(u => {
        tbody.innerHTML += `
...
function renderGlobalBookings(bookings) {
    ...
    if (bookings.length === 0) {
        tbody.innerHTML = "<tr><td colspan='6' style='text-align:center;'>No bookings found system-wide.</td></tr>";
        return;
    }
